...
def str_to_flagber(text):
    """ Encodes a text to a long flagber representation (big endian). """
    return int.from_bytes(text.encode("ASCII"), 'big')

def flagber_to_str(flag):
    """ Decodes a text to a long flagber representation (big endian). """
    flag = int(flag)
