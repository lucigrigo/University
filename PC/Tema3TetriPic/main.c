...
void StartBonus(char **gameTable, int height, int width) {
  ...
  for (i = 0; i < height; i++) {
    for (j = 0; j < width; j++) {
      ...
      case 'Z':
        ...
        break;
      case 'J':
        if ((gameTable[i][j + 1] != 'J') && (gameTable[i + 1][j] == 'J') &&
            gameTable[i + 2][j] == 'J') {
        ...
        break;
      case 'L':
        if ((gameTable[i][j + 1] == 'L') && (gameTable[i + 2][j] == 'L')) {
        ...
        break;
      case 'T':
        if ((gameTable[i][j + 1] == 'T') && (gameTable[i][j + 2] == 'T')) {
