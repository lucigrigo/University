...
proc create_root_design { parentCell } {
  ...
  set cin [ create_bd_port -dir I -from 0 -to 0 cin ]
  ...
  connect_bd_net -net Op2_1_1 [get_bd_ports cin] [get_bd_pins si_2/Op2] [get_bd_pins xor_1/Op2]
  ...
  connect_bd_net -net si_3_Res [get_bd_ports cout] [get_bd_pins si_3/Res]
  connect_bd_net -net xor_0_Res [get_bd_pins si_2/Op1] [get_bd_pins xor_0/Res] [get_bd_pins xor_1/Op1]
  connect_bd_net -net xor_1_Res [get_bd_ports sum] [get_bd_pins xor_1/Res]
