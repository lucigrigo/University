...
char* fjulia_in = NULL;
char* fjulia_out = NULL;
char* fmandelbrot_in = NULL;
char* fmandelbrot_out = NULL;
int no_threads = 0;             // numarul de thread-uri
pthread_barrier_t barrier;  // bariera folosita in rezolvare
int** julia = NULL;                // variabila in care va fi memorat fractalul Julia
int** mandelbrot = NULL;  // variabila in care va fi memorat fractalul Mandelbrot
...
TInputArgs* julia_args = NULL;       // arg de intrare pt Julia
TInputArgs* mandelbrot_args = NULL;  // arg de intrare pt Mandelbrot
