...
TextRenderer::TextRenderer(GLuint width, GLuint height)
{
	...
	shader->AddShader("Source/Laboratoare/Tema3/Shaders/VertexShaderText.glsl", GL_VERTEX_SHADER);
	shader->AddShader("Source/Laboratoare/Tema3/Shaders/FragmentShaderText.glsl", GL_FRAGMENT_SHADER);
